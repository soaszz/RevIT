            ...
            <div className="dashboard-column">
              ...
              <section className="focus-card">
                ...
                <p>{weakestTopic
                  ...
                  : "Select any combination of Clinical Chemistry, Hematology, Hematology 2, Bacteriology, AUBF, Immunology, Immunohematology, Laboratory Operations, Parasitology, and Mycology and Virology topics. RevIT preserves topic attribution in mixed reviews."}</p>
